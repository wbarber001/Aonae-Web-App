const attDescripts = [
  {
    attribute: "wisdom",
    text:
      "WISDOM, represents intelligence and knowledge. When checking to see if you know something or remember anything you add your wisdom to the roll.",
  },
  {
    attribute: "awareness",
    text:
      "AWARENESS, represents perception and intuition. When you attempt to see, listen, feel, I.e. gain information through your senses you add your awareness.",
  },
  {
    attribute: "soul",
    text:
      "SOUL, describes willpower, spiritual strength and charisma. Attempting to resist seduction, resist magic or trying to use charm are all examples of rolls to which you’d add Soul.",
  },
  {
    attribute: "strength",
    text:
      "STRENGTH, measures physical strength and endurance. Stunts to lift heavy weight, break hard material or wield melee weapons test Strength. As do attempts to resist the elements, poison or torture. Add Strength to such rolls.",
  },
  {
    attribute: "agility",
    text:
...
const abilities = [
  ...
  {
    ability: "Survival",
    text: "Find safe water, food and shelter in the wild.",
    attribute: "wisdom",
    modifier: 1,
  },
  {
...
const miracles = [
  ...
  },
  {
    ...
    type:
      "This talent allows the thief to become nearly invisible while in shadows. Spend ASE to add a bonus to both your Reflex and Sneak; 1 ASE = +1, 3 ASE = +3, 5 ASE = +5. Bonus last until your next action.Thief",
    text: "",
  },
  {
